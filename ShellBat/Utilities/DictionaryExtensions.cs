...
public static class DictionaryExtensions
{
    ...
    public static T? GetValue<T>(this IReadOnlyDictionary<string, string?>? dictionary, string name, T? defaultValue = default) => dictionary.GetValue(name, null, defaultValue);
    ...
    public static bool TryGetValue<T>(this IReadOnlyDictionary<string, string?>? dictionary, string name, out T? value) => dictionary.TryGetValue(name, null, out value);
    ...
    public static T? GetValue<T>(this IReadOnlyDictionary<string, object?>? dictionary, string name, T? defaultValue = default) => dictionary.GetValue(name, null, defaultValue);
    ...
    public static bool TryGetValue<T>(this IReadOnlyDictionary<string, object?>? dictionary, string name, out T? value) => dictionary.TryGetValue(name, null, out value);
    ...
    public static bool TryGetValueByPath<T>(this IReadOnlyDictionary<string, object?>? dictionary, string path, out T? value) => dictionary.TryGetValueByPath(path, null, out value);
    ...
    {
        if (!dictionary.TryGetValueByPath(path, out var obj))
        {
            value = default;
            return false;
        }
    ...
    {
        if (!dictionary.TryGetValueByPath(path, out object? value))
            return null;
    ...
    public static ConcurrentDictionary<TKey, TSource> ToConcurrentDictionary<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector) where TKey : notnull => source.ToConcurrentDictionary(keySelector, null);
    ...
    public static ValueTask<ConcurrentDictionary<TKey, TSource>> ToConcurrentDictionaryAsync<TSource, TKey>(this IAsyncEnumerable<TSource> source, Func<TSource, TKey> keySelector, CancellationToken cancellationToken = default) where TKey : notnull =>
        source.ToConcurrentDictionaryAsync(keySelector, comparer: null, cancellationToken);
    ...
    public static ValueTask<ConcurrentDictionary<TKey, TElement>> ToConcurrentDictionaryAsync<TSource, TKey, TElement>(this IAsyncEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector, CancellationToken cancellationToken = default) where TKey : notnull =>
        source.ToConcurrentDictionaryAsync(keySelector, elementSelector, comparer: null, cancellationToken);
