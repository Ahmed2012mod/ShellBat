...
public class EditorControlEventArgs(EditorControlEventType type, string? json = null)
    : HandledEventArgs
{
    private readonly Lazy<JsonDocument?> _document = new(() =>
    {
        ...
        return JsonSerializer.Deserialize(json, JsonSourceGenerationContext.Default.JsonDocument);
    });
