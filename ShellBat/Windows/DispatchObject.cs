...
public partial class DispatchObject : DirectN.IDispatch
{
    ...
    HRESULT DirectN.IDispatch.GetIDsOfNames(in Guid riid, PWSTR[] rgszNames, uint cNames, uint lcid, int[] rgDispId) =>
    ...
    HRESULT DirectN.IDispatch.GetTypeInfo(uint iTInfo, uint lcid, out ITypeInfo ppTInfo) => throw new NotSupportedException();
    HRESULT DirectN.IDispatch.GetTypeInfoCount(out uint pctinfo)
    {
        pctinfo = 0;
        return DirectN.Constants.S_OK;
    }
    ...
    [GeneratedComClass]
    private partial class Function(DispatchObject obj, MethodInfo method) : DirectN.IDispatch
    {
