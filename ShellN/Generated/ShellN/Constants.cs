...
public static partial class Constants
{
    ...
    public static readonly Guid AccessibilityDockingService = new("29ce1d46-b481-4aa0-a08a-d3ebc8aca402");
    ...
    public static readonly Guid AlphabeticalCategorizer = new("3c2654c6-7372-4f6b-b310-55d6128f49d2");
    
    public static readonly Guid ApplicationActivationManager = new("45ba127d-10a8-46ea-8ab7-56ea9078943c");
    
    public static readonly Guid ApplicationAssociationRegistration = new("591209c7-767b-42b2-9fba-44ee4615f2c7");
    
    public static readonly Guid ApplicationAssociationRegistrationUI = new("1968106d-f3b5-44cf-890e-116fcb9ecef1");
    
    public static readonly Guid ApplicationDesignModeSettings = new("958a6fb5-dcb2-4faf-aafd-7fb054ad1a3b");
    
    public static readonly Guid ApplicationDestinations = new("86c14003-4d6b-4ef3-a7b4-0506663b2e68");
    
    public static readonly Guid ApplicationDocumentLists = new("86bec222-30f2-47e0-9f25-60d11cd75c28");
    
    public const uint APPNAMEBUFFERLEN = 40;
    
    public static readonly Guid AppShellVerbHandler = new("4ed3a719-cea8-4bd9-910d-e252f997afc2");
    
    public static readonly Guid AppStartupLink = new("273eb5e7-88b0-4843-bfef-e2c81d43aae5");
    
    public static readonly Guid AppVisibility = new("7e5fe3d9-985f-4908-91f9-ee19f9fd1514");
    ...
    public static readonly Guid AttachmentServices = new("4125dd96-e03a-4103-8f70-e0597d803b9c");
    ...
    public static readonly Guid CATID_BrowsableShellExt = new("00021490-0000-0000-c000-000000000046");
    
    public static readonly Guid CATID_BrowseInPlace = new("00021491-0000-0000-c000-000000000046");
    
    public static readonly Guid CATID_CommBand = new("00021494-0000-0000-c000-000000000046");
    
    public static readonly Guid CATID_DeskBand = new("00021492-0000-0000-c000-000000000046");
    
    public static readonly Guid CATID_FilePlaceholderMergeHandler = new("3e9c9a51-d4aa-4870-b47c-7424b491f1cc");
    
    public static readonly Guid CATID_InfoBand = new("00021493-0000-0000-c000-000000000046");
    
    public static readonly Guid CATID_LocationFactory = new("965c4d51-8b76-4e57-80b7-564d2ea4b55e");
    
    public static readonly Guid CATID_LocationProvider = new("1b3ca474-2614-414b-b813-1aceca3e3dd8");
    
    public static readonly Guid CATID_SearchableApplication = new("366c292a-d9b3-4dbf-bb70-e62ec3d0bbbf");
    ...
    public static readonly Guid CDBurn = new("fbeb8a05-beee-4442-804e-409d6c4515e9");
    ...
    public static readonly Guid CGID_DefView = new("4af07f10-d231-11d0-b942-00a0c90312e1");
    
    public static readonly Guid CGID_Explorer = new("000214d0-0000-0000-c000-000000000046");
    
    public static readonly Guid CGID_ExplorerBarDoc = new("000214d3-0000-0000-c000-000000000046");
    
    public static readonly Guid CGID_MENUDESKBAR = new("5c9f0a12-959e-11d0-a3a4-00a0c9082636");
    
    public static readonly Guid CGID_ShellDocView = new("000214d1-0000-0000-c000-000000000046");
    
    public static readonly Guid CGID_ShellServiceObject = new("000214d2-0000-0000-c000-000000000046");
    
    public static readonly Guid CGID_ShortCut = new("93a68750-951a-11d1-946f-000000000000");
    
    public const uint CLOSEPROPS_DISCARD = 1;
    
    public const uint CLOSEPROPS_NONE = 0;
    
    public static readonly Guid CLSID_ACLCustomMRU = new("6935db93-21e8-4ccc-beb9-9fe3c77a297a");
    
    public static readonly Guid CLSID_ACLHistory = new("00bb2764-6a77-11d0-a535-00c04fd7d062");
    
    public static readonly Guid CLSID_ACListISF = new("03c036f1-a186-11d0-824a-00aa005b4383");
    
    public static readonly Guid CLSID_ACLMRU = new("6756a641-de71-11d0-831b-00aa005b4383");
    
    public static readonly Guid CLSID_ACLMulti = new("00bb2765-6a77-11d0-a535-00c04fd7d062");
    
    public static readonly Guid CLSID_ActiveDesktop = new("75048700-ef1f-11d0-9888-006097deacf9");
    
    public static readonly Guid CLSID_AutoComplete = new("00bb2763-6a77-11d0-a535-00c04fd7d062");
    
    public static readonly Guid CLSID_CAnchorBrowsePropertyPage = new("3050f3bb-98b5-11cf-bb82-00aa00bdce0b");
    
    public static readonly Guid CLSID_CDocBrowsePropertyPage = new("3050f3b4-98b5-11cf-bb82-00aa00bdce0b");
    
    public static readonly Guid CLSID_CFSIconOverlayManager = new("63b51f81-c868-11d0-999c-00c04fd655e1");
    
    public static readonly Guid CLSID_CImageBrowsePropertyPage = new("3050f3b3-98b5-11cf-bb82-00aa00bdce0b");
    
    public static readonly Guid CLSID_ControlPanel = new("21ec2020-3aea-1069-a2dd-08002b30309d");
    
    public static readonly Guid CLSID_CUrlHistory = new("3c374a40-bae4-11cf-bf7d-00aa006946ee");
    
    public static readonly Guid CLSID_CUrlHistoryBoth = new("6659983c-8476-4eb4-b78c-e5968f326ba0");
    
    public static readonly Guid CLSID_CURLSearchHook = new("cfbfae00-17a6-11d0-99cb-00c04fd64497");
    
    public static readonly Guid CLSID_DarwinAppPublisher = new("cfccc7a0-a282-11d1-9082-006008059382");
    
    public static readonly Guid CLSID_DocHostUIHandler = new("7057e952-bd1b-11d1-8919-00c04fc2c836");
    
    public static readonly Guid CLSID_DragDropHelper = new("4657278a-411b-11d2-839a-00c04fd918d0");
    
    public static readonly Guid CLSID_FileTypes = new("b091e540-83e3-11cf-a713-0020afd79762");
    
    public static readonly Guid CLSID_FolderItemsMultiLevel = new("53c74826-ab99-4d33-aca4-3117f51d3788");
    
    public static readonly Guid CLSID_FolderShortcut = new("0afaced1-e828-11d1-9187-b532f1e9575d");
    
    public static readonly Guid CLSID_HWShellExecute = new("ffb8655f-81b9-4fce-b89c-9a6ba76d13e7");
    
    public static readonly Guid CLSID_Internet = new("871c5380-42a0-1069-a2ea-08002b30309d");
    
    public static readonly Guid CLSID_InternetButtons = new("1e796980-9cc5-11d1-a83f-00c04fc99d61");
    
    public static readonly Guid CLSID_InternetShortcut = new("fbf23b40-e3f0-101b-8488-00aa003e56f8");
    
    public static readonly Guid CLSID_ISFBand = new("d82be2b0-5764-11d0-a96e-00c04fd705a2");
    
    public static readonly Guid CLSID_LinkColumnProvider = new("24f14f02-7b1c-11d1-838f-0000f80461cf");
    
    public static readonly Guid CLSID_MenuBand = new("5b4dae26-b807-11d0-9815-00c04fd91972");
    
    public static readonly Guid CLSID_MenuBandSite = new("e13ef4e4-d2f2-11d0-9816-00c04fd91972");
    
    public static readonly Guid CLSID_MenuToolbarBase = new("40b96610-b522-11d1-b3b4-00aa006efde7");
    
    public static readonly Guid CLSID_MSOButtons = new("178f34b8-a282-11d2-86c5-00c04f8eea99");
    
    public static readonly Guid CLSID_MyComputer = new("20d04fe0-3aea-1069-a2d8-08002b30309d");
    
    public static readonly Guid CLSID_MyDocuments = new("450d8fba-ad25-11d0-98a8-0800361b1103");
    
    public static readonly Guid CLSID_NetworkDomain = new("46e06680-4bf0-11d1-83ee-00a0c90dc849");
    
    public static readonly Guid CLSID_NetworkServer = new("c0542a90-4bf0-11d1-83ee-00a0c90dc849");
    
    public static readonly Guid CLSID_NetworkShare = new("54a754c0-4bf0-11d1-83ee-00a0c90dc849");
    
    public static readonly Guid CLSID_NewMenu = new("d969a300-e7ff-11d0-a93b-00a0c90f2719");
    
    public static readonly Guid CLSID_Printers = new("2227a280-3aea-1069-a2de-08002b30309d");
    
    public static readonly Guid CLSID_ProgressDialog = new("f8383852-fcd3-11d1-a6b9-006097df5bd4");
    
    public static readonly Guid CLSID_QueryAssociations = new("a07034fd-6caa-4954-ac3f-97a27216f98a");
    
    public static readonly Guid CLSID_QuickLinks = new("0e5cbf21-d15f-11d0-8301-00aa005b4383");
    
    public static readonly Guid CLSID_RecycleBin = new("645ff040-5081-101b-9f08-00aa002f954e");
    
    public static readonly Guid CLSID_ShellFldSetExt = new("6d5313c0-8c62-11d1-b2cd-006097df8c11");
    
    public static readonly Guid CLSID_ShellThumbnailDiskCache = new("1ebdcf80-a200-11d0-a3a4-00c04fd706ec");
    
    public static readonly Guid CLSID_ToolbarExtButtons = new("2ce4b5d8-a28f-11d2-86c5-00c04f8eea99");
    
    public static readonly Guid CLSID_WPD_NAMESPACE_EXTENSION = new("35786d3c-b075-49b9-88dd-029876e11c01");
    ...
    public static readonly Guid ConflictFolder = new("289978ac-a101-4341-a817-21eba7fd046d");
    
    public static readonly Guid CPFG_CREDENTIAL_PROVIDER_LABEL = new("286bbff3-bad4-438f-b007-79b7267c3d48");
    
    public static readonly Guid CPFG_CREDENTIAL_PROVIDER_LOGO = new("2d837775-f6cd-464e-a745-482fd0b47493");
    
    public static readonly Guid CPFG_LOGON_PASSWORD = new("60624cfa-a477-47b1-8a8e-3a4a19981827");
    
    public static readonly Guid CPFG_LOGON_USERNAME = new("da15bbe8-954d-4fd3-b0f4-1fb5b90b174b");
    
    public static readonly Guid CPFG_SMARTCARD_PIN = new("4fe5263b-9181-46c1-b0a4-9dedd4db7dea");
    
    public static readonly Guid CPFG_SMARTCARD_USERNAME = new("3e1ecf69-568c-4d96-9d59-46444174e2d6");
    
    public static readonly Guid CPFG_STANDALONE_SUBMIT_BUTTON = new("0b7b0ad8-cc36-4d59-802b-82f714fa7022");
    
    public static readonly Guid CPFG_STYLE_LINK_AS_BUTTON = new("088fa508-94a6-4430-a4cb-6fc6e3c0b9e2");
    ...
    public static readonly Guid CScriptErrorList = new("efd01300-160f-11d2-bb2e-00805ff7efca");
    
    public static readonly Guid CSearchManager = new("7d096c5f-ac08-4f1f-beb7-5c22c517ce39");
    ...
    public static readonly Guid DefFolderMenu = new("c63382be-7933-48d0-9ac8-85fb46be2fdd");
    
    public static readonly Guid DesktopGadget = new("924ccc1b-6562-4c85-8657-d177925222b6");
    ...
    public static readonly Guid DocPropShellExtension = new("883373c3-bf89-11d1-be35-080036b11a03");
    
    public static readonly Guid DriveSizeCategorizer = new("94357b53-ca29-4b78-83ae-e8fe7409134f");
    
    public static readonly Guid DriveTypeCategorizer = new("b0a8f3cf-4333-4bab-8873-1ccb1cada48b");
    ...
    public static readonly Guid EnumBthMtpConnectors = new("a1570149-e645-4f43-8b0d-409b061db2fc");
    
    public static readonly Guid EnumerableObjectCollection = new("2d3468c1-36a7-43b6-ac24-d3f02fd9607a");
    
    public static readonly Guid EP_AdvQueryPane = new("b4e9db8b-34ba-4c39-b5cc-16a1bd2c411c");
    
    public static readonly Guid EP_Commands = new("d9745868-ca5f-4a76-91cd-f5a129fbb076");
    
    public static readonly Guid EP_Commands_Organize = new("72e81700-e3ec-4660-bf24-3c3b7b648806");
    
    public static readonly Guid EP_Commands_View = new("21f7c32d-eeaa-439b-bb51-37b96fd6a943");
    
    public static readonly Guid EP_DetailsPane = new("43abf98b-89b8-472d-b9ce-e69b8229f019");
    
    public static readonly Guid EP_NavPane = new("cb316b22-25f7-42b8-8a09-540d23a43c2f");
    
    public static readonly Guid EP_PreviewPane = new("893c63d1-45c8-4d17-be19-223be71be365");
    
    public static readonly Guid EP_QueryPane = new("65bcde4f-4f07-4f27-83a7-1afca4df7ddd");
    
    public static readonly Guid EP_Ribbon = new("d27524a8-c9f2-4834-a106-df8889fd4f37");
    
    public static readonly Guid EP_StatusBar = new("65fe56ce-5cfe-4bc4-ad8a-7ae3fe7e8f7c");
    
    public static readonly Guid ExecuteFolder = new("11dbb47c-a525-400b-9e80-a54615a090c0");
    
    public static readonly Guid ExecuteUnknown = new("e44e9428-bdbc-4987-a099-40dc8fd255e7");
    ...
    public static readonly Guid ExplorerBrowser = new("71f96385-ddd6-48d3-a0c1-ae06e8b055fb");
    ...
    public static readonly Guid FileSaveDialog = new("c0b4e2f3-ba21-4773-8dba-335ec946eb8b");
    
    public static readonly Guid FileSearchBand = new("c4ee31f3-4768-11d2-be5c-00a0c9a83da1");
    ...
    public static readonly Guid FMTID_Briefcase = new("328d8b21-7729-4bfc-954c-902b329d56b0");
    
    public static readonly Guid FMTID_CustomImageProperties = new("7ecd8b0e-c136-4a9b-9411-4ebd6673ccc3");
    
    public static readonly Guid FMTID_Displaced = new("9b174b33-40ff-11d2-a27e-00c04fc30871");
    
    public static readonly Guid FMTID_DRM = new("aeac19e4-89ae-4508-b9b7-bb867abee2ed");
    
    public static readonly Guid FMTID_ImageProperties = new("14b81da1-0135-4d31-96d9-6cbfc9671a99");
    
    public static readonly Guid FMTID_InternetSite = new("000214a1-0000-0000-c000-000000000046");
    
    public static readonly Guid FMTID_Intshcut = new("000214a0-0000-0000-c000-000000000046");
    
    public static readonly Guid FMTID_LibraryProperties = new("5d76b67f-9b3d-44bb-b6ae-25da4f638a67");
    
    public static readonly Guid FMTID_Misc = new("9b174b34-40ff-11d2-a27e-00c04fc30871");
    
    public static readonly Guid FMTID_MUSIC = new("56a3372e-ce9c-11d2-9f0e-006097c686f6");
    
    public static readonly Guid FMTID_Query = new("49691c90-7e17-101a-a91c-08002b2ecda9");
    
    public static readonly Guid FMTID_ShellDetails = new("28636aa6-953d-11d2-b5d6-00c04fd918d0");
    
    public static readonly Guid FMTID_Storage = new("b725f130-47ef-101a-a5f1-02608c9eebac");
    
    public static readonly Guid FMTID_Volume = new("9b174b35-40ff-11d2-a27e-00c04fc30871");
    
    public static readonly Guid FMTID_WebView = new("f2275480-f782-4291-bd94-f13693513aec");
    ...
    public static readonly Guid FOLDERID_AllAppMods = new("7ad67899-66af-43ba-9156-6aad42e6c596");
    
    public static readonly Guid FOLDERID_AppCaptures = new("edc0fe71-98d8-4f4a-b920-c8dc133cb165");
    ...
    public static readonly Guid FOLDERID_CameraRollLibrary = new("2b20df75-1eda-4039-8097-38798227d5b7");
    ...
    public static readonly Guid FOLDERID_CommonStartMenuPlaces = new("a440879f-87a0-4f7d-b700-0207b966194a");
    ...
    public static readonly Guid FOLDERID_CurrentAppMods = new("3db40b20-2a30-4dbe-917e-771dd21dd099");
    
    public static readonly Guid FOLDERID_Desktop = new("b4bfcc3a-db2c-424c-b029-7fe99a87c641");
    
    public static readonly Guid FOLDERID_DevelopmentFiles = new("dbe8e08e-3053-4bbc-b183-2a7b2b191e59");
    ...
    public static readonly Guid FOLDERID_LocalDocuments = new("f42ee2d3-909f-4907-8871-4c22fc0bf756");
    
    public static readonly Guid FOLDERID_LocalDownloads = new("7d83ee9b-2244-4e70-b1f5-5393042af1e4");
    
    public static readonly Guid FOLDERID_LocalizedResourcesDir = new("2a00375e-224c-49de-b8d1-440df7ef3ddc");
    
    public static readonly Guid FOLDERID_LocalMusic = new("a0c69a99-21c8-4671-8703-7934162fcf1d");
    
    public static readonly Guid FOLDERID_LocalPictures = new("0ddd015d-b06c-45d5-8c4c-f59713854639");
    
    public static readonly Guid FOLDERID_LocalStorage = new("b3eb08d3-a1f3-496b-865a-42b536cda0ec");
    
    public static readonly Guid FOLDERID_LocalVideos = new("35286a68-3c57-41a1-bbb1-0eae73d76c95");
    ...
    public static readonly Guid FOLDERID_RecordedCalls = new("2f8b40c2-83ed-48ee-b383-a1f157ec6f9a");
    ...
    public static readonly Guid FOLDERID_RetailDemo = new("12d4c69e-24ad-4923-be19-31321c43a767");
    ...
    public static readonly Guid FOLDERID_SkyDriveMusic = new("c3f2459e-80d6-45dc-bfef-1f769f2be730");
    ...
    public static readonly Guid FOLDERID_StartMenuAllPrograms = new("f26305ef-6948-40b9-b255-81453d09c785");
    ...
    public static readonly Guid FOLDERTYPEID_AccountPictures = new("db2a5d8f-06e6-4007-aba6-af877d526ea6");
    
    public static readonly Guid FOLDERTYPEID_Communications = new("91475fe5-586b-4eba-8d75-d17434b8cdf6");
    
    public static readonly Guid FOLDERTYPEID_CompressedFolder = new("80213e82-bcfd-4c4f-8817-bb27601267a9");
    
    public static readonly Guid FOLDERTYPEID_Contacts = new("de2b70ec-9bf7-4a93-bd3d-243f7881d492");
    
    public static readonly Guid FOLDERTYPEID_ControlPanelCategory = new("de4f0660-fa10-4b8f-a494-068b20b22307");
    
    public static readonly Guid FOLDERTYPEID_ControlPanelClassic = new("0c3794f3-b545-43aa-a329-c37430c58d2a");
    
    public static readonly Guid FOLDERTYPEID_Documents = new("7d49d726-3c21-4f05-99aa-fdc2c9474656");
    
    public static readonly Guid FOLDERTYPEID_Downloads = new("885a186e-a440-4ada-812b-db871b942259");
    
    public static readonly Guid FOLDERTYPEID_Games = new("b689b0d0-76d3-4cbb-87f7-585d0e0ce070");
    
    public static readonly Guid FOLDERTYPEID_Generic = new("5c4f28b5-f869-4e84-8e60-f11db97c5cc7");
    
    public static readonly Guid FOLDERTYPEID_GenericLibrary = new("5f4eab9a-6833-4f61-899d-31cf46979d49");
    
    public static readonly Guid FOLDERTYPEID_GenericSearchResults = new("7fde1a1e-8b31-49a5-93b8-6be14cfa4943");
    
    public static readonly Guid FOLDERTYPEID_Invalid = new("57807898-8c4f-4462-bb63-71042380b109");
    
    public static readonly Guid FOLDERTYPEID_Music = new("94d6ddcc-4a68-4175-a374-bd584a510b78");
    
    public static readonly Guid FOLDERTYPEID_NetworkExplorer = new("25cc242b-9a7c-4f51-80e0-7a2928febe42");
    
    public static readonly Guid FOLDERTYPEID_OpenSearch = new("8faf9629-1980-46ff-8023-9dceab9c3ee3");
    
    public static readonly Guid FOLDERTYPEID_OtherUsers = new("b337fd00-9dd5-4635-a6d4-da33fd102b7a");
    
    public static readonly Guid FOLDERTYPEID_Pictures = new("b3690e58-e961-423b-b687-386ebfd83239");
    
    public static readonly Guid FOLDERTYPEID_Printers = new("2c7bbec6-c844-4a0a-91fa-cef6f59cfda1");
    
    public static readonly Guid FOLDERTYPEID_PublishedItems = new("7f2f5b96-ff74-41da-afd8-1c78a5f3aea2");
    
    public static readonly Guid FOLDERTYPEID_RecordedTV = new("5557a28f-5da6-4f83-8809-c2c98a11a6fa");
    
    public static readonly Guid FOLDERTYPEID_RecycleBin = new("d6d9e004-cd87-442b-9d57-5e0aeb4f6f72");
    
    public static readonly Guid FOLDERTYPEID_SavedGames = new("d0363307-28cb-4106-9f23-2956e3e5e0e7");
    
    public static readonly Guid FOLDERTYPEID_SearchConnector = new("982725ee-6f47-479e-b447-812bfa7d2e8f");
    
    public static readonly Guid FOLDERTYPEID_Searches = new("0b0ba2e3-405f-415e-a6ee-cad625207853");
    
    public static readonly Guid FOLDERTYPEID_SearchHome = new("834d8a44-0974-4ed6-866e-f203d80b3810");
    
    public static readonly Guid FOLDERTYPEID_SoftwareExplorer = new("d674391b-52d9-4e07-834e-67c98610f39d");
    
    public static readonly Guid FOLDERTYPEID_StartMenu = new("ef87b4cb-f2ce-4785-8658-4ca6c63e38c6");
    
    public static readonly Guid FOLDERTYPEID_StorageProviderDocuments = new("dd61bd66-70e8-48dd-9655-65c5e1aac2d1");
    
    public static readonly Guid FOLDERTYPEID_StorageProviderGeneric = new("4f01ebc5-2385-41f2-a28e-2c5c91fb56e0");
    
    public static readonly Guid FOLDERTYPEID_StorageProviderMusic = new("672ecd7e-af04-4399-875c-0290845b6247");
    
    public static readonly Guid FOLDERTYPEID_StorageProviderPictures = new("71d642a9-f2b1-42cd-ad92-eb9300c7cc0a");
    
    public static readonly Guid FOLDERTYPEID_StorageProviderVideos = new("51294da1-d7b1-485b-9e9a-17cffe33e187");
    ...
    public static readonly Guid FolderViewHost = new("20b1cb23-6968-4eb9-b7d4-a66d00d07cee");
    
    public static readonly Guid FrameworkInputPane = new("d5120aa3-46ba-44c5-822d-ca8092c1fc72");
    
    public static readonly Guid FreeSpaceCategorizer = new("b5607793-24ac-44c7-82e2-831726aa6cb7");
    
    public static readonly Guid FSCopyHandler = new("d197380a-0a79-4dc8-a033-ed882c2fa14b");
    ...
    public static readonly Guid GenericCredentialProvider = new("25cbb996-92ed-457e-b28c-4774084bd562");
    ...
    public static readonly Guid HideInputPaneAnimationCoordinator = new("384742b1-2a77-4cb3-8cf8-1136f5e17e59");
    ...
    public static readonly Guid HomeGroup = new("de77ba04-3c92-4d11-a1a5-42352a53e0e3");
    ...
    public static readonly Guid Identity_LocalUserProvider = new("a198529b-730f-4089-b646-a12557f5665e");
    ...
    public static readonly Guid IENamespaceTreeControl = new("ace52d03-e5cd-4b20-82ff-e71b11beae1d");
    
    public const uint ILMM_IE4 = 0;
    
    public static readonly Guid ImageProperties = new("7ab770c7-0e23-4d7a-8aa2-19bfad479829");
    
    public static readonly Guid ImageRecompress = new("6e33091c-d2f8-4740-b55e-2e11d1477a2c");
    
    public static readonly Guid ImageTranscode = new("17b75166-928f-417d-9685-64aa135565c1");
    
    public static readonly Guid InMemoryPropertyStore = new("9a02e012-6303-4e1e-b9a1-630f802592c5");
    
    public static readonly Guid InMemoryPropertyStoreMarshalByValue = new("d4ca0e2d-6da7-4b75-a97c-5f306f0eaedc");
    
    public static readonly Guid InputPanelConfiguration = new("2853add3-f096-4c63-a78f-7fa3ea837fb7");
    
    public const uint INTERNET_MAX_PATH_LENGTH = 2048;
    
    public const uint INTERNET_MAX_SCHEME_LENGTH = 32;
    
    public static readonly Guid InternetExplorer = new("0002df01-0000-0000-c000-000000000046");
    
    public static readonly Guid InternetExplorerMedium = new("d5e8041d-920f-45e9-b8fb-b1deb82c6e5e");
    
    public static readonly Guid InternetPrintOrdering = new("add36aa8-751a-4579-a266-d66f5202ccbb");
    ...
    public static readonly Guid ItemCount_Property_GUID = new("abbf5c45-5ccc-47b7-bb4e-87cb87bbd162");
    
    public static readonly Guid ItemIndex_Property_GUID = new("92a053da-2969-4021-bf27-514cfc2e4a69");
    ...
    public static readonly Guid KnownFolderManager = new("4df0c730-df9d-4ae3-9153-aa6b82e9795a");
    
    public static readonly Guid LocalThumbnailCache = new("50ef4544-ac9f-4a8e-b21b-8a26180db13f");
    
    public static readonly Guid MailRecipient = new("9e56be60-c50f-11cf-9a2c-00a0c90a90ce");
    ...
    public static readonly Guid MergedCategorizer = new("8e827c11-33e7-4bc1-b242-8cd9a1c2b304");
    
    public static readonly Guid MSDAINITIALIZE = new("2206cdb0-19c1-11d1-89e0-00c04fd7a829");
    ...
    public static readonly Guid NamespaceTreeControl = new("ae054212-3535-4430-83ed-d501aa6680e6");
    
    public static readonly Guid NamespaceWalker = new("72eb61e0-8672-4303-9175-f2e4c68b2e7c");
    ...
    public static readonly Guid NetworkExplorerFolder = new("f02c1a0d-be21-4350-88b0-7367fc96ef3c");
    
    public static readonly Guid NetworkPlaces = new("208d2c60-3aea-1069-a2d7-08002b30309d");
    ...
    public static readonly Guid NPCredentialProvider = new("3dd6bec0-8193-4ffe-ae25-e08e39ea4063");
    ...
    public static readonly Guid OnexCredentialProvider = new("07aa0886-cc8d-4e19-a410-1c75af686e62");
    
    public static readonly Guid OnexPlapSmartcardCredentialProvider = new("33c86cd6-705f-4ba1-9adb-67070b837775");
    
    public static readonly Guid OpenControlPanel = new("06622d85-6856-4460-8de1-a81921b41c4b");
    
    public const uint OPENPROPS_INHIBITPIF = 32768;
    
    public const uint OPENPROPS_NONE = 0;
    
    public static readonly Guid PackageDebugSettings = new("b1aec16f-2383-4852-b0e9-8f0b1dc66b4d");
    ...
    public static readonly Guid PasswordCredentialProvider = new("60b78e88-ead8-445c-9cfd-0b87f74ea6cd");
    ...
    public static readonly Guid PINLogonCredentialProvider = new("cb82ea12-9f71-446d-89e1-8d0924e1256e");
    ...
    public static readonly Guid PortableDevice = new("728a21c5-3d9e-48d7-9810-864848f0f404");
    
    public static readonly Guid PortableDeviceDispatchFactory = new("43232233-8338-4658-ae01-0b4ae830b6b0");
    ...
    public static readonly Guid PortableDeviceService = new("ef5db4c2-9312-422c-9152-411cd9c4dd84");
    
    public static readonly Guid PortableDeviceServiceFTM = new("1649b154-c794-497a-9b03-f3f0121302f3");
    
    public static readonly Guid PortableDeviceValues = new("0c15d503-d017-47ce-9016-7b3f978721cc");
    
    public static readonly Guid PortableDeviceValuesCollection = new("3882134d-14cf-4220-9cb4-435f86d83f60");
    
    public static readonly Guid PortableDeviceWebControl = new("186dd02c-2dec-41b5-a7d4-b59056fade51");
    ...
    public static readonly Guid PreviousVersions = new("596ab062-b4d2-4215-9f74-e9109b0a8153");
    ...
    public static readonly Guid PropertiesUI = new("d912f8cf-0396-4915-884e-fb425d32943b");
    
    public static readonly Guid PropertySystem = new("b8967f85-58ae-4f46-9fb2-5d7904798f4b");
    
    public const string PROPSTR_EXTENSIONCOMPLETIONSTATE = @"ExtensionCompletionState";
    
    public static readonly Guid PSGUID_AUDIO = new("64440490-4c8b-11d1-8b70-080036b11a03");
    
    public static readonly Guid PSGUID_BRIEFCASE = new("328d8b21-7729-4bfc-954c-902b329d56b0");
    
    public static readonly Guid PSGUID_CONTROLPANEL = new("305ca226-d286-468e-b848-2b2e8e697b74");
    
    public static readonly Guid PSGUID_CUSTOMIMAGEPROPERTIES = new("7ecd8b0e-c136-4a9b-9411-4ebd6673ccc3");
    
    public static readonly Guid PSGUID_DISPLACED = new("9b174b33-40ff-11d2-a27e-00c04fc30871");
    
    public static readonly Guid PSGUID_DOCUMENTSUMMARYINFORMATION = new("d5cdd502-2e9c-101b-9397-08002b2cf9ae");
    
    public static readonly Guid PSGUID_DRM = new("aeac19e4-89ae-4508-b9b7-bb867abee2ed");
    
    public static readonly Guid PSGUID_IMAGEPROPERTIES = new("14b81da1-0135-4d31-96d9-6cbfc9671a99");
    
    public static readonly Guid PSGUID_IMAGESUMMARYINFORMATION = new("6444048f-4c8b-11d1-8b70-080036b11a03");
    
    public static readonly Guid PSGUID_LIBRARYPROPERTIES = new("5d76b67f-9b3d-44bb-b6ae-25da4f638a67");
    
    public static readonly Guid PSGUID_LINK = new("b9b4b3fc-2b51-4a42-b5d8-324146afcf25");
    
    public static readonly Guid PSGUID_MEDIAFILESUMMARYINFORMATION = new("64440492-4c8b-11d1-8b70-080036b11a03");
    
    public static readonly Guid PSGUID_MISC = new("9b174b34-40ff-11d2-a27e-00c04fc30871");
    
    public static readonly Guid PSGUID_MUSIC = new("56a3372e-ce9c-11d2-9f0e-006097c686f6");
    
    public static readonly Guid PSGUID_QUERY_D = new("49691c90-7e17-101a-a91c-08002b2ecda9");
    
    public static readonly Guid PSGUID_SHARE = new("d8c3986f-813b-449c-845d-87b95d674ade");
    
    public static readonly Guid PSGUID_SHELLDETAILS = new("28636aa6-953d-11d2-b5d6-00c04fd918d0");
    
    public static readonly Guid PSGUID_SUMMARYINFORMATION = new("f29f85e0-4ff9-1068-ab91-08002b27b3d9");
    
    public static readonly Guid PSGUID_VIDEO = new("64440491-4c8b-11d1-8b70-080036b11a03");
    
    public static readonly Guid PSGUID_VOLUME = new("9b174b35-40ff-11d2-a27e-00c04fc30871");
    
    public static readonly Guid PSGUID_WEBVIEW = new("f2275480-f782-4291-bd94-f13693513aec");
    
    public static readonly Guid PublishDropTarget = new("cc6eeffb-43f6-46c5-9619-51d571967f7d");
    
    public static readonly Guid PublishingWizard = new("6b33163c-76a5-4b6c-bf21-45de9cd503a1");
    
    public const uint QCMINFO_PLACE_AFTER = 1;
    
    public const uint QCMINFO_PLACE_BEFORE = 0;
    
    public static readonly Guid QueryCancelAutoPlay = new("331f1768-05a9-4ddd-b86e-dae34ddc998a");
    ...
    public static readonly Guid RASProvider = new("5537e283-b1e7-4ef8-9c6e-7ab0afe5056d");
    ...
    public static readonly Guid ScheduledTasks = new("d6277990-4c6a-11cf-8d87-00aa0060f5bf");
    ...
    public static readonly Guid SearchFolderItemFactory = new("14010e02-bbbd-41f0-88e3-eda371216584");
    ...
    public static readonly Guid SelectedItemCount_Property_GUID = new("8fe316d2-0e52-460a-9c1e-48f273d470a3");
    ...
    public static readonly Guid SharedBitmap = new("4db26476-6787-4046-b836-e8412a9e8a27");
    ...
    public static readonly Guid SharingConfigurationManager = new("49f371e1-8c5c-4d9c-9a3b-54a6827f513c");
    ...
    public static readonly Guid Shell = new("13709620-c279-11ce-a49e-444553540000");
    
    public static readonly Guid ShellBrowserWindow = new("c08afd90-f2a1-11d1-8455-00a0c91f3880");
    
    public static readonly Guid ShellDesktop = new("00021400-0000-0000-c000-000000000046");
    
    public static readonly Guid ShellDispatchInproc = new("0a89a860-d7b1-11ce-8350-444553540000");
    
    public const string SHELLEX_WIAUIEXTENSION_NAME = @"WiaDialogExtensionHandlers";
    
    public static readonly Guid ShellFolderItem = new("2fe352ea-fd1f-11d2-b1f4-00c04f8eeb3e");
    
    public static readonly Guid ShellFolderView = new("62112aa1-ebe4-11cf-a5fb-0020afe7292d");
    
    public static readonly Guid ShellFolderViewOC = new("9ba05971-f6a8-11cf-a442-00a0c90a8f39");
    
    public static readonly Guid ShellFSFolder = new("f3364ba0-65b9-11ce-a9ba-00aa004ae837");
    
    public static readonly Guid ShellImageDataFactory = new("66e4e4fb-f385-4dd0-8d74-a2efd1bc6178");
    
    public static readonly Guid ShellItem = new("9ac9fbe1-e0a2-4ad6-b4ee-e212013ea917");
    
    public static readonly Guid ShellLibrary = new("d9b3211d-e57f-4426-aaef-30a806add397");
    
    public static readonly Guid ShellLink = new("00021401-0000-0000-c000-000000000046");
    
    public static readonly Guid ShellLinkObject = new("11219420-1768-11d1-95be-00609797ea4f");
    
    public static readonly Guid ShellNameSpace = new("55136805-b2de-11d1-b9f2-00a0c98bc547");
    
    public const uint SHELLSTATEVERSION_IE4 = 9;
    
    public const uint SHELLSTATEVERSION_WIN2K = 10;
    
    public static readonly Guid ShellUIHelper = new("64ab4bb7-111e-11d1-8f79-00c04fc2fbe1");
    ...
    public static readonly Guid ShowInputPaneAnimationCoordinator = new("1f046abf-3202-4dc1-8cb5-3c67617ce1fa");
    ...
    public static readonly Guid SID_CommandsPropertyBag = new("6e043250-4416-485c-b143-e62a760d9fe5");
    
    public static readonly Guid SID_CtxQueryAssociations = new("faadfc40-b777-4b69-aa81-77035ef0e6e8");
    
    public static readonly Guid SID_DefView = new("6d12fe80-7911-11cf-9534-0000c05bae0b");
    
    public static readonly Guid SID_LaunchSourceAppUserModelId = new("2ce78010-74db-48bc-9c6a-10f372495723");
    
    public static readonly Guid SID_LaunchSourceViewSizePreference = new("80605492-67d9-414f-af89-a1cdf1242bc1");
    
    public static readonly Guid SID_LaunchTargetViewSizePreference = new("26db2472-b7b7-406b-9702-730a4e20d3bf");
    
    public static readonly Guid SID_MenuShellFolder = new("a6c17eb4-2d65-11d2-838f-00c04fd918d0");
    
    public static readonly Guid SID_SCommandBarState = new("b99eaa5c-3850-4400-bc33-2ce534048bf8");
    
    public static readonly Guid SID_SCommDlgBrowser = new("80f30233-b7df-11d2-a33b-006097df5bd4");
    
    public static readonly Guid SID_SGetViewFromViewDual = new("889a935d-971e-4b12-b90c-24dfc9e1e5e8");
    
    public static readonly Guid SID_ShellExecuteNamedPropertyStore = new("eb84ada2-00ff-4992-8324-ed5ce061cb29");
    
    public static readonly Guid SID_SInPlaceBrowser = new("1d2ae02b-3655-46cc-b63a-285988153bca");
    
    public static readonly Guid SID_SMenuBandBKContextMenu = new("164bbd86-1d0d-4de0-9a3b-d9729647c2b8");
    
    public static readonly Guid SID_SMenuBandBottom = new("743ca664-0deb-11d1-9825-00c04fd91972");
    
    public static readonly Guid SID_SMenuBandBottomSelected = new("165ebaf4-6d51-11d2-83ad-00c04fd918d0");
    
    public static readonly Guid SID_SMenuBandChild = new("ed9cc020-08b9-11d1-9823-00c04fd91972");
    
    public static readonly Guid SID_SMenuBandContextMenuModifier = new("39545874-7162-465e-b783-2aa1874fef81");
    
    public static readonly Guid SID_SMenuBandParent = new("8c278eec-3eab-11d1-8cb0-00c04fd918d0");
    
    public static readonly Guid SID_SMenuBandTop = new("9493a810-ec38-11d0-bc46-00aa006ce2f5");
    
    public static readonly Guid SID_SMenuPopup = new("d1e7afeb-6a2e-11d0-8c78-00c04fd918b4");
    
    public static readonly Guid SID_SSearchBoxInfo = new("142daa61-516b-4713-b49c-fb985ef82998");
    
    public static readonly Guid SID_STopLevelBrowser = new("4c96be40-915c-11cf-99d3-00aa004ae837");
    
    public static readonly Guid SID_STopWindow = new("49e1b500-4636-11d3-97f7-00c04f45d0b3");
    
    public static readonly Guid SID_URLExecutionContext = new("fb5f8ebc-bbb6-4d10-a461-777291a09030");
    
    public static readonly Guid SimpleConflictPresenter = new("7a0f6ab7-ed84-46b6-b47e-02aa159a152b");
    ...
    public static readonly Guid SizeCategorizer = new("55d7b852-f6d1-42f2-aa75-8728a1b2d264");
    ...
    public static readonly Guid SmartcardCredentialProvider = new("8fd7e19c-3bf7-489b-a72c-846ab3678c96");
    
    public static readonly Guid SmartcardPinProvider = new("94596c7e-3744-41ce-893e-bbf09122f76a");
    
    public static readonly Guid SmartcardReaderSelectionProvider = new("1b283861-754f-4022-ad47-a5eaaa618894");
    
    public static readonly Guid SmartcardWinRTProvider = new("1ee7337f-85ac-45e2-a23c-37c753209769");
    ...
    public static readonly Guid StartMenuPin = new("a2a9545d-a0c2-42b4-9708-a0b2badd77c8");
    
    public const int STIF_DEFAULT = 0;
    
    public const int STIF_SUPPORT_HEX = 1;
    
    public static readonly Guid StorageProviderBanners = new("7ccdf9f4-e576-455a-8bc7-f6ec68d6f063");
    ...
    public static readonly Guid SuspensionDependencyManager = new("6b273fc5-61fd-4918-95a2-c3b5e9d7f581");
    
    public static readonly Guid SyncMgr = new("6295df27-35ee-11d1-8707-00c04fd93327");
    
    public static readonly Guid SYNCMGR_OBJECTID_BrowseContent = new("57cbb584-e9b4-47ae-a120-c4df3335dee2");
    
    public static readonly Guid SYNCMGR_OBJECTID_ConflictStore = new("d78181f4-2389-47e4-a960-60bcc2ed930b");
    
    public static readonly Guid SYNCMGR_OBJECTID_EventLinkClick = new("2203bdc1-1af1-4082-8c30-28399f41384c");
    
    public static readonly Guid SYNCMGR_OBJECTID_EventStore = new("4bef34b9-a786-4075-ba88-0c2b9d89a98f");
    
    public static readonly Guid SYNCMGR_OBJECTID_Icon = new("6dbc85c3-5d07-4c72-a777-7fec78072c06");
    
    public static readonly Guid SYNCMGR_OBJECTID_QueryBeforeActivate = new("d882d80b-e7aa-49ed-86b7-e6e1f714cdfe");
    
    public static readonly Guid SYNCMGR_OBJECTID_QueryBeforeDeactivate = new("a0efc282-60e0-460e-9374-ea88513cfc80");
    
    public static readonly Guid SYNCMGR_OBJECTID_QueryBeforeDelete = new("f76c3397-afb3-45d7-a59f-5a49e905437e");
    
    public static readonly Guid SYNCMGR_OBJECTID_QueryBeforeDisable = new("bb5f64aa-f004-4eb5-8e4d-26751966344c");
    
    public static readonly Guid SYNCMGR_OBJECTID_QueryBeforeEnable = new("04cbf7f0-5beb-4de1-bc90-908345c480f6");
    
    public static readonly Guid SYNCMGR_OBJECTID_ShowSchedule = new("edc6f3e3-8441-4109-adf3-6c1ca0b7de47");
    
    public static readonly Guid SyncMgrClient = new("1202db60-1dac-42c5-aed5-1abdd432248e");
    
    public static readonly Guid SyncMgrControl = new("1a1f4206-0688-4e7f-be03-d82ec69df9a5");
    
    public static readonly Guid SyncMgrFolder = new("9c73f5e5-7ae7-4e32-a8e8-8d23b85255bf");
    ...
    public static readonly Guid SyncMgrScheduleWizard = new("8d8b8e30-c451-421b-8553-d2976afa648c");
    
    public static readonly Guid SyncResultsFolder = new("71d99464-3b6b-475c-b241-e15883207529");
    
    public static readonly Guid SyncSetupFolder = new("2e9e59c0-b437-4981-a647-9c34b9b90891");
    ...
    public static readonly Guid TaskbarList = new("56fdf344-fd6d-11d0-958a-006097c9a090");
    ...
    public static readonly Guid ThumbnailStreamCache = new("cbe0fed3-4b91-4e90-8354-8a8c84ec6872");
    
    public static readonly Guid TimeCategorizer = new("3bb4118f-ddfd-4d30-a348-9fb5d6bf1afe");
    ...
    public static readonly Guid TrackShellMenu = new("8278f931-2a3e-11d2-838f-00c04fd918d0");
    
    public static readonly Guid TrayBandSiteService = new("f60ad0a0-e5e1-45cb-b51a-e15b9f8b2934");
    
    public static readonly Guid TrayDeskBand = new("e6442437-6c68-4f52-94dd-2cfed267efb9");
    ...
    public static readonly Guid UserNotification = new("0010890e-8789-413c-adbc-48f5b511b3af");
    
    public static readonly Guid V1PasswordCredentialProvider = new("6f45dc1e-5384-457a-bc13-2cd81b0d28ed");
    
    public static readonly Guid V1SmartcardCredentialProvider = new("8bf9a910-a8ff-457f-999f-a5ca10b4a885");
    
    public static readonly Guid V1WinBioCredentialProvider = new("ac3ac249-e820-4343-a65b-377ac634dc09");
    
    public static readonly Guid VaultProvider = new("503739d0-4c5e-4cfd-b3ba-d881334f0df2");
    
    public static readonly Guid VID_Content = new("30c2c434-0889-4c8d-985d-a9f71830b0a9");
    
    public static readonly Guid VID_Details = new("137e7700-3573-11cf-ae69-08002b2e1262");
    
    public static readonly Guid VID_LargeIcons = new("0057d0e0-3573-11cf-ae69-08002b2e1262");
    
    public static readonly Guid VID_List = new("0e1fa5e0-3573-11cf-ae69-08002b2e1262");
    
    public static readonly Guid VID_SmallIcons = new("089000c0-3573-11cf-ae69-08002b2e1262");
    
    public static readonly Guid VID_Thumbnails = new("8bebb290-52d0-11d0-b7f4-00c04fd706ec");
    
    public static readonly Guid VID_ThumbStrip = new("8eefa624-d1e9-445b-94b7-74fbce2ea11a");
    
    public static readonly Guid VID_Tile = new("65f125e5-7be1-4810-ba9d-d271c8432ce3");
    ...
    public static readonly Guid WebBrowser = new("8856f961-340a-11d0-a96b-00c04fd705a2");
    
    public static readonly Guid WebBrowser_V1 = new("eab22ac3-30c1-11cf-a7eb-0000c05bae0b");
    
    public static readonly Guid WebWizardHost = new("c827f149-55c1-4d28-935e-57e47caed973");
    
    public static readonly Guid WinBioCredentialProvider = new("bec09223-b018-416d-a0ac-523971b639f5");
    
    public const uint WM_CPL_LAUNCH = 2024;
    
    public const uint WM_CPL_LAUNCHED = 2025;
    
    public static readonly Guid WPD_API_OPTIONS_V1 = new("10e54a3e-052d-4777-a13c-de7614be2bc4");
    
    public static readonly Guid WPD_APPOINTMENT_OBJECT_PROPERTIES_V1 = new("f99efd03-431d-40d8-a1c9-4e220d9c88d3");
    
    public static readonly Guid WPD_CATEGORY_CAPABILITIES = new("0cabec78-6b74-41c6-9216-2639d1fce356");
    
    public static readonly Guid WPD_CATEGORY_COMMON = new("f0422a9c-5dc8-4440-b5bd-5df28835658a");
    
    public static readonly Guid WPD_CATEGORY_DEVICE_HINTS = new("0d5fb92b-cb46-4c4f-8343-0bc3d3f17c84");
    
    public static readonly Guid WPD_CATEGORY_MEDIA_CAPTURE = new("59b433ba-fe44-4d8d-808c-6bcb9b0f15e8");
    
    public static readonly Guid WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS = new("4d545058-1a2e-4106-a357-771e0819fc56");
    
    public static readonly Guid WPD_CATEGORY_NETWORK_CONFIGURATION = new("78f9c6fc-79b8-473c-9060-6bd23dd072c4");
    
    public static readonly Guid WPD_CATEGORY_NULL = new("00000000-0000-0000-0000-000000000000");
    
    public static readonly Guid WPD_CATEGORY_OBJECT_ENUMERATION = new("b7474e91-e7f8-4ad9-b400-ad1a4b58eeec");
    
    public static readonly Guid WPD_CATEGORY_OBJECT_MANAGEMENT = new("ef1e43dd-a9ed-4341-8bcc-186192aea089");
    
    public static readonly Guid WPD_CATEGORY_OBJECT_PROPERTIES = new("9e5582e4-0814-44e6-981a-b2998d583804");
    
    public static readonly Guid WPD_CATEGORY_OBJECT_PROPERTIES_BULK = new("11c824dd-04cd-4e4e-8c7b-f6efb794d84e");
    
    public static readonly Guid WPD_CATEGORY_OBJECT_RESOURCES = new("b3a2b22d-a595-4108-be0a-fc3c965f3d4a");
    
    public static readonly Guid WPD_CATEGORY_SERVICE_CAPABILITIES = new("24457e74-2e9f-44f9-8c57-1d1bcb170b89");
    
    public static readonly Guid WPD_CATEGORY_SERVICE_COMMON = new("322f071d-36ef-477f-b4b5-6f52d734baee");
    
    public static readonly Guid WPD_CATEGORY_SERVICE_METHODS = new("2d521ca8-c1b0-4268-a342-cf19321569bc");
    
    public static readonly Guid WPD_CATEGORY_SMS = new("afc25d66-fe0d-4114-9097-970c93e920d1");
    
    public static readonly Guid WPD_CATEGORY_STILL_IMAGE_CAPTURE = new("4fcd6982-22a2-4b05-a48b-62d38bf27b32");
    
    public static readonly Guid WPD_CATEGORY_STORAGE = new("d8f907a6-34cc-45fa-97fb-d007fa47ec94");
    
    public static readonly Guid WPD_CLASS_EXTENSION_OPTIONS_V1 = new("6309ffef-a87c-4ca7-8434-797576e40a96");
    
    public static readonly Guid WPD_CLASS_EXTENSION_OPTIONS_V2 = new("3e3595da-4d71-49fe-a0b4-d4406c3ae93f");
    
    public static readonly Guid WPD_CLASS_EXTENSION_OPTIONS_V3 = new("65c160f8-1367-4ce2-939d-8310839f0d30");
    
    public static readonly Guid WPD_CLASS_EXTENSION_V1 = new("33fb0d11-64a3-4fac-b4c7-3dfeaa99b051");
    
    public static readonly Guid WPD_CLASS_EXTENSION_V2 = new("7f0779b5-fa2b-4766-9cb2-f73ba30b6758");
    
    public static readonly Guid WPD_CLIENT_INFORMATION_PROPERTIES_V1 = new("204d9f0c-2292-4080-9f42-40664e70f859");
    
    public static readonly Guid WPD_COMMON_INFORMATION_OBJECT_PROPERTIES_V1 = new("b28ae94b-05a4-4e8e-be01-72cc7e099d8f");
    
    public static readonly Guid WPD_CONTACT_OBJECT_PROPERTIES_V1 = new("fbd4fdab-987d-4777-b3f9-726185a9312b");
    
    public static readonly Guid WPD_CONTENT_TYPE_ALL = new("80e170d2-1055-4a3e-b952-82cc4f8a8689");
    
    public static readonly Guid WPD_CONTENT_TYPE_APPOINTMENT = new("0fed060e-8793-4b1e-90c9-48ac389ac631");
    
    public static readonly Guid WPD_CONTENT_TYPE_AUDIO = new("4ad2c85e-5e2d-45e5-8864-4f229e3c6cf0");
    
    public static readonly Guid WPD_CONTENT_TYPE_AUDIO_ALBUM = new("aa18737e-5009-48fa-ae21-85f24383b4e6");
    
    public static readonly Guid WPD_CONTENT_TYPE_CALENDAR = new("a1fd5967-6023-49a0-9df1-f8060be751b0");
    
    public static readonly Guid WPD_CONTENT_TYPE_CERTIFICATE = new("dc3876e8-a948-4060-9050-cbd77e8a3d87");
    
    public static readonly Guid WPD_CONTENT_TYPE_CONTACT = new("eaba8313-4525-4707-9f0e-87c6808e9435");
    
    public static readonly Guid WPD_CONTENT_TYPE_CONTACT_GROUP = new("346b8932-4c36-40d8-9415-1828291f9de9");
    
    public static readonly Guid WPD_CONTENT_TYPE_DOCUMENT = new("680adf52-950a-4041-9b41-65e393648155");
    
    public static readonly Guid WPD_CONTENT_TYPE_EMAIL = new("8038044a-7e51-4f8f-883d-1d0623d14533");
    ...
    public static readonly Guid WPD_CONTENT_TYPE_GENERIC_MESSAGE = new("e80eaaf8-b2db-4133-b67e-1bef4b4a6e5f");
    
    public static readonly Guid WPD_CONTENT_TYPE_IMAGE = new("ef2107d5-a52a-4243-a26b-62d4176d7603");
    
    public static readonly Guid WPD_CONTENT_TYPE_IMAGE_ALBUM = new("75793148-15f5-4a30-a813-54ed8a37e226");
    
    public static readonly Guid WPD_CONTENT_TYPE_MEDIA_CAST = new("5e88b3cc-3e65-4e62-bfff-229495253ab0");
    
    public static readonly Guid WPD_CONTENT_TYPE_MEMO = new("9cd20ecf-3b50-414f-a641-e473ffe45751");
    
    public static readonly Guid WPD_CONTENT_TYPE_MIXED_CONTENT_ALBUM = new("00f0c3ac-a593-49ac-9219-24abca5a2563");
    
    public static readonly Guid WPD_CONTENT_TYPE_NETWORK_ASSOCIATION = new("031da7ee-18c8-4205-847e-89a11261d0f3");
    
    public static readonly Guid WPD_CONTENT_TYPE_PLAYLIST = new("1a33f7e4-af13-48f5-994e-77369dfe04a3");
    
    public static readonly Guid WPD_CONTENT_TYPE_PROGRAM = new("d269f96a-247c-4bff-98fb-97f3c49220e6");
    
    public static readonly Guid WPD_CONTENT_TYPE_SECTION = new("821089f5-1d91-4dc9-be3c-bbb1b35b18ce");
    
    public static readonly Guid WPD_CONTENT_TYPE_TASK = new("63252f2c-887f-4cb6-b1ac-d29855dcef6c");
    
    public static readonly Guid WPD_CONTENT_TYPE_TELEVISION = new("60a169cf-f2ae-4e21-9375-9677f11c1c6e");
    
    public static readonly Guid WPD_CONTENT_TYPE_UNSPECIFIED = new("28d8d31e-249c-454e-aabc-34883168e634");
    
    public static readonly Guid WPD_CONTENT_TYPE_VIDEO = new("9261b03c-3d78-4519-85e3-02c5e1f50bb9");
    
    public static readonly Guid WPD_CONTENT_TYPE_VIDEO_ALBUM = new("012b0db7-d4c1-45d6-b081-94b87779614f");
    
    public static readonly Guid WPD_CONTENT_TYPE_WIRELESS_PROFILE = new("0bac070a-9f5f-4da4-a8f6-3de44d68fd6c");
    
    public const uint WPD_CONTROL_FUNCTION_GENERIC_MESSAGE = 66;
    
    public const string WPD_DEVICE_OBJECT_ID = @"DEVICE";
    
    public static readonly Guid WPD_DEVICE_PROPERTIES_V1 = new("26d4979a-e643-4626-9e2b-736dc0c92fdc");
    
    public static readonly Guid WPD_DEVICE_PROPERTIES_V2 = new("463dd662-7fc4-4291-911c-7f4c9cca9799");
    
    public static readonly Guid WPD_DEVICE_PROPERTIES_V3 = new("6c2b878c-c2ec-490d-b425-d7a75e23e5ed");
    
    public static readonly Guid WPD_DOCUMENT_OBJECT_PROPERTIES_V1 = new("0b110203-eb95-4f02-93e0-97c631493ad5");
    
    public static readonly Guid WPD_EMAIL_OBJECT_PROPERTIES_V1 = new("41f8f65a-5484-4782-b13d-4740dd7c37c5");
    
    public static readonly Guid WPD_EVENT_ATTRIBUTES_V1 = new("10c96578-2e81-4111-adde-e08ca6138f6d");
    
    public static readonly Guid WPD_EVENT_DEVICE_CAPABILITIES_UPDATED = new("36885aa1-cd54-4daa-b3d0-afb3e03f5999");
    
    public static readonly Guid WPD_EVENT_DEVICE_REMOVED = new("e4cbca1b-6918-48b9-85ee-02be7c850af9");
    
    public static readonly Guid WPD_EVENT_DEVICE_RESET = new("7755cf53-c1ed-44f3-b5a2-451e2c376b27");
    
    public static readonly Guid WPD_EVENT_MTP_VENDOR_EXTENDED_EVENTS = new("00000000-5738-4ff2-8445-be3126691059");
    
    public static readonly Guid WPD_EVENT_NOTIFICATION = new("2ba2e40a-6b4c-4295-bb43-26322b99aeb2");
    
    public static readonly Guid WPD_EVENT_OBJECT_ADDED = new("a726da95-e207-4b02-8d44-bef2e86cbffc");
    
    public static readonly Guid WPD_EVENT_OBJECT_REMOVED = new("be82ab88-a52c-4823-96e5-d0272671fc38");
    
    public static readonly Guid WPD_EVENT_OBJECT_TRANSFER_REQUESTED = new("8d16a0a1-f2c6-41da-8f19-5e53721adbf2");
    
    public static readonly Guid WPD_EVENT_OBJECT_UPDATED = new("1445a759-2e01-485d-9f27-ff07dae697ab");
    
    public static readonly Guid WPD_EVENT_OPTIONS_V1 = new("b3d8dad7-a361-4b83-8a48-5b02ce10713b");
    
    public static readonly Guid WPD_EVENT_PROPERTIES_V1 = new("15ab1953-f817-4fef-a921-5676e838f6e0");
    
    public static readonly Guid WPD_EVENT_PROPERTIES_V2 = new("52807b8a-4914-4323-9b9a-74f654b2b846");
    
    public static readonly Guid WPD_EVENT_SERVICE_METHOD_COMPLETE = new("8a33f5f8-0acc-4d9b-9cc4-112d353b86ca");
    
    public static readonly Guid WPD_EVENT_STORAGE_FORMAT = new("3782616b-22bc-4474-a251-3070f8d38857");
    
    public static readonly Guid WPD_FOLDER_OBJECT_PROPERTIES_V1 = new("7e9a7abf-e568-4b34-aa2f-13bb12ab177d");
    
    public static readonly Guid WPD_FORMAT_ATTRIBUTES_V1 = new("a0a02000-bcaf-4be8-b3f5-233f231cf58f");
    
    public static readonly Guid WPD_FUNCTIONAL_CATEGORY_ALL = new("2d8a6512-a74c-448e-ba8a-f4ac07c49399");
    
    public static readonly Guid WPD_FUNCTIONAL_CATEGORY_AUDIO_CAPTURE = new("3f2a1919-c7c2-4a00-855d-f57cf06debbb");
    
    public static readonly Guid WPD_FUNCTIONAL_CATEGORY_DEVICE = new("08ea466b-e3a4-4336-a1f3-a44d2b5c438c");
    
    public static readonly Guid WPD_FUNCTIONAL_CATEGORY_NETWORK_CONFIGURATION = new("48f4db72-7c6a-4ab0-9e1a-470e3cdbf26a");
    
    public static readonly Guid WPD_FUNCTIONAL_CATEGORY_RENDERING_INFORMATION = new("08600ba4-a7ba-4a01-ab0e-0065d0a356d3");
    
    public static readonly Guid WPD_FUNCTIONAL_CATEGORY_SMS = new("0044a0b1-c1e9-4afd-b358-a62c6117c9cf");
    ...
    public static readonly Guid WPD_FUNCTIONAL_CATEGORY_VIDEO_CAPTURE = new("e23e5f6b-7243-43aa-8df1-0eb3d968a918");
    
    public static readonly Guid WPD_FUNCTIONAL_OBJECT_PROPERTIES_V1 = new("8f052d93-abca-4fc5-a5ac-b01df4dbe598");
    
    public static readonly Guid WPD_IMAGE_OBJECT_PROPERTIES_V1 = new("63d64908-9fa1-479f-85ba-9952216447db");
    
    public static readonly Guid WPD_MEDIA_PROPERTIES_V1 = new("2ed8ba05-0ad3-42dc-b0d0-bc95ac396ac8");
    
    public static readonly Guid WPD_MEMO_OBJECT_PROPERTIES_V1 = new("5ffbfc7b-7483-41ad-afb9-da3f4e592b8d");
    
    public static readonly Guid WPD_METHOD_ATTRIBUTES_V1 = new("f17a5071-f039-44af-8efe-432cf32e432a");
    
    public static readonly Guid WPD_MUSIC_OBJECT_PROPERTIES_V1 = new("b324f56a-dc5d-46e5-b6df-d2ea414888c6");
    
    public static readonly Guid WPD_NETWORK_ASSOCIATION_PROPERTIES_V1 = new("e4c93c1f-b203-43f1-a100-5a07d11b0274");
    
    public static readonly Guid WPD_OBJECT_FORMAT_3G2 = new("b9850000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_3G2A = new("1a11202d-8759-4e34-ba5e-b1211087eee4");
    
    public static readonly Guid WPD_OBJECT_FORMAT_3GP = new("b9840000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_3GPA = new("e5172730-f971-41ef-a10b-2271a0019d7a");
    
    public static readonly Guid WPD_OBJECT_FORMAT_AAC = new("b9030000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_ABSTRACT_CONTACT = new("bb810000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_ABSTRACT_CONTACT_GROUP = new("ba060000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_ABSTRACT_MEDIA_CAST = new("ba0b0000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_AIFF = new("30070000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_ALL = new("c1f62eb2-4bb3-479c-9cfa-05b5f3a57b22");
    
    public static readonly Guid WPD_OBJECT_FORMAT_AMR = new("b9080000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_ASF = new("300c0000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_ASXPLAYLIST = new("ba130000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_ATSCTS = new("b9870000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_AUDIBLE = new("b9040000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_AVCHD = new("b9860000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_AVI = new("300a0000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_BMP = new("38040000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_CIFF = new("38050000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_DPOF = new("30060000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_DVBTS = new("b9880000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_EXECUTABLE = new("30030000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_EXIF = new("38010000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_FLAC = new("b9060000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_FLASHPIX = new("38030000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_GIF = new("38070000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_HTML = new("30050000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_ICALENDAR = new("be030000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_ICON = new("077232ed-102c-4638-9c22-83f142bfc822");
    
    public static readonly Guid WPD_OBJECT_FORMAT_JFIF = new("38080000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_JP2 = new("380f0000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_JPEGXR = new("b8040000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_JPX = new("38100000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_M3UPLAYLIST = new("ba110000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_M4A = new("30aba7ac-6ffd-4c23-a359-3e9b52f3f1c8");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MHT_COMPILED_HTML = new("ba840000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MICROSOFT_EXCEL = new("ba850000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MICROSOFT_POWERPOINT = new("ba860000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MICROSOFT_WFC = new("b1040000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MICROSOFT_WORD = new("ba830000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MKV = new("b9900000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MP2 = new("b9830000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MP3 = new("30090000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MP4 = new("b9820000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MPEG = new("300b0000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_MPLPLAYLIST = new("ba120000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_NETWORK_ASSOCIATION = new("b1020000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_OGG = new("b9020000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_PCD = new("38090000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_PICT = new("380a0000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_PLSPLAYLIST = new("ba140000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_PNG = new("380b0000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_PROPERTIES_ONLY = new("30010000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_QCELP = new("b9070000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_SCRIPT = new("30020000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_TEXT = new("30040000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_TIFF = new("380d0000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_TIFFEP = new("38020000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_TIFFIT = new("380e0000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_UNSPECIFIED = new("30000000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_VCALENDAR1 = new("be020000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_VCARD2 = new("bb820000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_VCARD3 = new("bb830000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_WAVE = new("30080000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_WBMP = new("b8030000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_WINDOWSIMAGEFORMAT = new("b8810000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_WMA = new("b9010000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_WMV = new("b9810000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_WPLPLAYLIST = new("ba100000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_X509V3CERTIFICATE = new("b1030000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_FORMAT_XML = new("ba820000-ae6c-4804-98ba-c57b46965fe7");
    
    public static readonly Guid WPD_OBJECT_PROPERTIES_V1 = new("ef6b490d-5cd8-437a-affc-da8b60ee4a3c");
    
    public static readonly Guid WPD_OBJECT_PROPERTIES_V2 = new("0373cd3d-4a46-40d7-b4d8-73e8da74e775");
    
    public static readonly Guid WPD_PARAMETER_ATTRIBUTES_V1 = new("e6864dd7-f325-45ea-a1d5-97cf73b6ca58");
    
    public static readonly Guid WPD_PROPERTIES_MTP_VENDOR_EXTENDED_DEVICE_PROPS = new("4d545058-8900-40b3-8f1d-dc246e1e8370");
    
    public static readonly Guid WPD_PROPERTIES_MTP_VENDOR_EXTENDED_OBJECT_PROPS = new("4d545058-4fce-4578-95c8-8698a9bc0f49");
    
    public static readonly Guid WPD_PROPERTY_ATTRIBUTES_V1 = new("ab7943d8-6332-445f-a00d-8d5ef1e96f37");
    
    public static readonly Guid WPD_PROPERTY_ATTRIBUTES_V2 = new("5d9da160-74ae-43cc-85a9-fe555a80798e");
    
    public static readonly Guid WPD_RENDERING_INFORMATION_OBJECT_PROPERTIES_V1 = new("c53d039f-ee23-4a31-8590-7639879870b4");
    
    public static readonly Guid WPD_RESOURCE_ATTRIBUTES_V1 = new("1eb6f604-9278-429f-93cc-5bb8c06656b6");
    
    public static readonly Guid WPD_SECTION_OBJECT_PROPERTIES_V1 = new("516afd2b-c64e-44f0-98dc-bee1c88f7d66");
    
    public static readonly Guid WPD_SERVICE_PROPERTIES_V1 = new("7510698a-cb54-481c-b8db-0d75c93f1c06");
    
    public static readonly Guid WPD_SMS_OBJECT_PROPERTIES_V1 = new("7e1074cc-50ff-4dd1-a742-53be6f093a0d");
    
    public static readonly Guid WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1 = new("58c571ec-1bcb-42a7-8ac5-bb291573a260");
    
    public static readonly Guid WPD_STORAGE_OBJECT_PROPERTIES_V1 = new("01a3057a-74d6-4e80-bea7-dc4c212ce50a");
    
    public static readonly Guid WPD_TASK_OBJECT_PROPERTIES_V1 = new("e354e95e-d8a0-4637-a03a-0cb26838dbc7");
    
    public static readonly Guid WPD_VIDEO_OBJECT_PROPERTIES_V1 = new("346f2163-f998-4146-8b01-d19b4c00de9a");
    
    public static readonly Guid WPDNSE_OBJECT_PROPERTIES_V1 = new("34d71409-4b47-4d80-aaac-3a28a4a3b3e6");
    ...
    public static readonly Guid WpdSerializer = new("0b91a74b-ad7c-4a9d-b563-29eef9167172");
